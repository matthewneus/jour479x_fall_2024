...
**Answer** DESCRIBE THE RESULTS HERE - This is a spreadsheet of NBA Players and their stats for each team they were on last season. It lists the player's age, teams and stats, like points and rebounds and assists.
...
**Answer** DESCRIBE THE RESULTS HERE - There were more shooting guards in the NBA than any other position in the NBA with 162. There were 139 centers, 133 shooting forwards, 115 point guards and 121 power forwards. The league is designed for guards, especially shooting guards.
...
**Answer** NAME A COMPLICATING FACTOR CONTAINED IN THE RESULT & HOW YOU WOULD RESOLVE IT. - One complicating factor is why are players considered a power forward and a center, or a point guard and a shooting guard. I would resolve it by making everyone a guard and eliminating titles like shooting and point.
...
**ANSWER** - The one that seems the most interesting to me is that center average the least amount of minutes despite being the second most popular position. I could do a story on how centers are utilized and if some teams are going away from using centers, and explore the role of centers in the NBA.
